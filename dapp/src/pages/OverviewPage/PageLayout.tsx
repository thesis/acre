...
import { Grid, GridProps, Box, VStack } from "@chakra-ui/react"

function PageLayoutSidebar(props: { children: React.ReactNode }) {
...
const PageLayout = Object.assign(PageLayoutBase, { Sidebar: PageLayoutSidebar })
